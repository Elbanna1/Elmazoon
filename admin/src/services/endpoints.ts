 ...
 * `/api/analytics/*`, `/api/articles/comments/pending`, `/api/articles/comments/{id}/approve`,
 * `POST /api/articles/{id}/view` — are deliberately absent: the analytics screens
 * and the comment-moderation flow were removed from the product, and a route map
 * that lists calls nobody makes is a map you cannot trust.
 *
